...
from app.schemas.fhir import CodeableConcept, Reference, Meta
...
class AppointmentCreate(BaseModel):
    ...
    status: str = Field(default="proposed", description="proposed | pending | booked | arrived | fulfilled | cancelled | noshow")
    appointment_type: Optional[str] = Field(None, description="ROUTINE | URGENT | EMERGENCY | FOLLOWUP")
    service_category: Optional[str] = Field(None, description="General Practice | Specialist | Therapy")
...
class FHIRAppointment(BaseModel):
    ...
    status: str = Field(..., description="proposed | pending | booked | arrived | fulfilled | cancelled | noshow")
    appointmentType: Optional[CodeableConcept] = Field(None, description="The style of appointment")
    serviceCategory: Optional[List[CodeableConcept]] = Field(None, description="Category of service")
