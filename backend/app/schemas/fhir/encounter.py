...
class EncounterCreate(BaseModel):
    ...
    encounter_class: str = Field(
        ..., description="inpatient | outpatient | ambulatory | emergency | home | field | virtual"
    )
    status: str = Field(
        default="planned",
...
class FHIREncounter(BaseModel):
    ...
    class_: CodeableConcept = Field(
        ..., alias="class", description="Classification of patient encounter"
    )
    ...
    reasonCode: Optional[List[CodeableConcept]] = Field(
        None, description="Coded reason the encounter takes place"
    )
