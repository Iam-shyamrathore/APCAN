...
class CodeableConcept(BaseModel):
    ...
    """
    code: Optional[str] = Field(None, description="Code from terminology system (SNOMED, LOINC, etc.)")
...
class Reference(BaseModel):
    ...
    type: Optional[str] = Field(None, description="Type the reference refers to (e.g., Patient, Practitioner)")
