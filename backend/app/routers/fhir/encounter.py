...
from app.schemas.fhir.encounter import EncounterCreate, EncounterUpdate, EncounterResponse, FHIREncounter
...
async def search_encounters(
    ...
    """
    query = select(Encounter).where(Encounter.is_deleted == False)
